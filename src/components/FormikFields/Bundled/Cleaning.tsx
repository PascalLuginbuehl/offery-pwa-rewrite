...
export default ({ prefix, resource }: { prefix: string; resource: IResource }) => {
  return (
    <>
      ...
      <Field label="BALCONY_TERRASSE" name={`${prefix}.BalconyId`} component={Select} options={resource.Balconies.map(e => ({ label: e.NameTextKey, value: e.BalconyId }))} />
      <Field label="FLOOR" name={`${prefix}.FloorTypeId`} component={Select} options={resource.FloorTypes.map(e => ({ label: e.NameTextKey, value: e.FloorTypeId }))} />
      <Field
        label="ROLLERBLIND"
      ...
      <Field label="GARAGE" name={`${prefix}.GarageTypeId`} component={Select} options={resource.GarageTypes.map(e => ({ label: e.NameTextKey, value: e.GarageTypeId }))} />
      <Field
